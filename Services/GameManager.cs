...
namespace Tron.Server.Services
{
    ...
    // Pomocnicza klasa do przechowywania informacji o pojedymczym graczu - zarówno ludzi, jak i botów
    ...
    //klasa pomocnicza do konwersji GPS <-> SIATKA
    ...
    // klasa do przechowywania współrzędnych 
    public class Coordinate { public double Lat { get; set; } public double Lon { get; set; } }


    // Klasa reprezentująca pojedynczą grę na serwerze
    ...
    public class GameManager
    {
        ...
        // metoda czyszcząca listę graczy w grze
        ...
        // metoda aktualizująca stan gracza
        ...
        // Metoda przesuwająca gracza i sprawdzająca kolizje
        ...
        // metoda zwracająca stan wszystkich graczy w grze
